...
import type { GameByIdResponse, VideoByUserIdResponse } from "../data/types";
...
// 
export const fetchVideoByUserId = async (user_id: string): Promise<VideoByUserIdResponse | null> => {
